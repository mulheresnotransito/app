        ...
        <View style={{ width: '100%', alignItems: 'center', justifyContent: 'center' }}>
          ...
          <View style={{ flexDirection: 'row', flexWrap: 'nowrap', width: '95%', justifyContent: 'center', alignItems: 'space-between', marginVertical: 20 }}>
            <View style={{ flex: 1 }} >
              ...
              <Styled.TxtInput1 placeholder="Nome" value="Isabela" style={{ color: '#E46788' }} />
            </View>
            <View style={{ flex: 1 }} >
              <Text style={{ marginHorizontal: 10, fontSize: 12, color: '#C96786', fontWeight: '400' }}>Sobrenome</Text>
              <Styled.TxtInput1 placeholder="Sobrenome" value="Faria" style={{ color: '#E46788' }} />
            </View>
          </View>
          ...
          <View style={{ flexDirection: 'row', flexWrap: 'nowrap', width: '95%', justifyContent: 'center', alignItems: 'space-between', marginVertical: 20 }}>
            ...
            <View style={{ flex: 1 }} >
              ...
              <Styled.TxtInput1 placeholder="E-mail" value="isa@gmail.com" style={{ color: '#E46788' }} />
            </View>
          </View>
