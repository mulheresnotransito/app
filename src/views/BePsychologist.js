...
import image from '../assets/images/be-psychologist.png';

import * as Styled from '../assets/styles/styled';
import Header from '../components/Header';
import Footer from '../components/Footer';

const BePsychologist = (props) => {
  ...
  return (
    <Styled.Container style={{ paddingTop: 0 }}>
      ...
      <Styled.ScrollContainer>
        ...
        <Styled.TxtQuestion style={{ marginVertical: 10, fontSize: 16, width: '60%', fontWeight: '700', textAlign: 'center' }}>Psicóloga parceira tem muitas vantagens!</Styled.TxtQuestion>
...
que estejam dispostas a ajudar!</Styled.TxtQuestion>
          </View>
        </View>
...
export default connect(mapStateToProps, mapDispatchToProps)(BePsychologist);