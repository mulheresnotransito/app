...
const DriverWallet = (props) => {

  const [btnActive, setBtnActive] = React.useState('free-hours');

  const [freeHours, setFreeHours] = React.useState([
    { id: 1, day: '29', month: 'setembro', title: 'aula prática', description: 'início: 19:30' },
    { id: 2, day: '29', month: 'setembro', title: 'aula prática', description: 'início: 20:00' },
    { id: 3, day: '29', month: 'setembro', title: 'aula prática', description: 'início: 21:00' },
    { id: 4, day: '29', month: 'setembro', title: 'aula prática', description: 'início: 19:30' },
    { id: 5, day: '29', month: 'setembro', title: 'aula prática', description: 'início: 19:30' },
  ]);

  const [nextHours, setNextHours] = React.useState([
    { id: 1, day: '27', month: 'julho', title: 'aula prática', description: 'início: 12:00' },
    { id: 2, day: '17', month: 'agosto', title: 'aula prática', description: 'início: 12:30' },
    { id: 3, day: '05', month: 'setembro', title: 'aula prática', description: 'início: 15:00' },
    { id: 4, day: '05', month: 'outubro', title: 'aula prática', description: 'início: 18:30' },
    { id: 5, day: '15', month: 'novembro', title: 'aula prática', description: 'início: 19:00' },
  ]);

  const [history, setHistory] = React.useState([
    { id: 1, day: '01', month: 'julho', title: 'aula prática', description: 'início: 19:30' },
    { id: 2, day: '05', month: 'agosto', title: 'aula prática', description: 'início: 19:30' },
    { id: 3, day: '08', month: 'setembro', title: 'aula prática', description: 'início: 19:30' },
    { id: 4, day: '26', month: 'outubro', title: 'aula prática', description: 'início: 19:30' },
    { id: 5, day: '01', month: 'novembro', title: 'aula prática', description: 'início: 19:30' },
  ]);
      ...
      <Styled.ScrollContainer>
        ...
        <View style={{ alignItems: 'center', justifyContent: 'center', width: '95%', marginVertical: 10, flexDirection: 'row', flexWrap: 'nowrap', }}>
          ...
          <View style={{ marginHorizontal: 15, flex: 1 }}>
            <Text style={{ fontWeight: '600', fontSize: 18, color: "#C43A57" }}>Isabela Faria</Text>
        ...
        <View style={{ alignItems: 'center', justifyContent: 'center', backgroundColor: '#C43A57', width: '100%', paddingVertical: 20, paddingHorizontal: 10, marginBottom: -20, flexDirection: 'row', flexWrap: 'nowrap' }}>
          ...
          <View style={{ flexDirection: 'row', flexWrap: 'nowrap', justifyContent: 'center', alignItems: 'center', flex: 1 }}>
            ...
            <Text style={{ fontWeight: '800', fontSize: 32, color: "#fff", margin: 0, padding: 0, textAlign: 'left' }}>1.650,00</Text>
          </View>
        </View>
