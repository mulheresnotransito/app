...
const BuyConsultationsCredits = (props) => {
  ...
  const [packages, setPackages] = React.useState([
    { id: 1, title: "1 consulta", installments: 1, price: "R$65,00", description: "", active: true, credits: 1 },
    { id: 2, title: "5 consultas", installments: 2, price: "R$320,00", description: "(em até 2x no cartão de crédito)", active: false, credits: 5 },
    { id: 3, title: "10 consultas", installments: 3, price: "R$630,00", description: "(em até 3x no cartão de crédito)", active: false, credits: 10 },
    { id: 4, title: "15 consultas", installments: 4, price: "R$930,00", description: "(em até 4x no cartão de crédito)", active: false, credits: 15 },
  ]);
